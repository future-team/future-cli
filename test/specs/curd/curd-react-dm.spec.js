...
// _.forEach(['controller', 'model', 'utils', 'view'], (value)=>{
//     fs.remove(path.join(MOCK_PROJECT_DIRECTORY, value), (err) => {
//         if (err) return console.error(err)
//         //console.log('success!')
//     })
// })
describe('gfs react-dm curd', () => {
    beforeEach( () => {
    ...
    // add web
    it('`first add --template react-dm --type web --name gfs-test`: `view/pages/GfsTest.jsx` should exist.', (done) => {
        ...
        expect(addFiles.indexOf('view/pages/GfsTest.jsx')).not.equal(-1)
        const isTrue = fs.existsSync(path.join(MOCK_PROJECT_DIRECTORY, 'view/pages/GfsTest.jsx'))
        expect(isTrue).to.be.a('boolean')
