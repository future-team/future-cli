...
module.exports.getTemplate = function getTemplate(name, opts) {
    // TODO 如何定义文件的命名
    const filePath = path.join(__dirname, `../templates/webpack_react_redux_cortex/web/${name}.${opts.extension}.template`);
